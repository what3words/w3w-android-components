...
Checkout the W3WAutoSuggestEditText Compose port [readme](https://github.com/what3words/w3w-android-components/dev/compose-sample#readme) if you intend to use the W3WAutoSuggestComponent in Jetpack Compose. 
